...
public sealed class CameraSettingsDto
{
    ...
    [DataMember(Name = "isoOptions", Order = 4, EmitDefaultValue = true)]
    public List<string> IsoOptions { get; set; } = new List<string>();

    [DataMember(Name = "shutterOptions", Order = 5, EmitDefaultValue = true)]
    public List<string> ShutterOptions { get; set; } = new List<string>();

    [DataMember(Name = "whiteBalanceOptions", Order = 6, EmitDefaultValue = true)]
